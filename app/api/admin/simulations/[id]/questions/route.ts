...
export async function GET(
  ...
  try {
    ...
    console.error(
      "Erro ao consultar questões do simulado:",
      error
    );
...
export async function PUT(
  ...
  try {
    ...
    await replaceSimulationQuestionIds(
      simulationId,
      questionIds
    );
    ...
    console.error(
      "Erro ao atualizar questões do simulado:",
      error
    );
